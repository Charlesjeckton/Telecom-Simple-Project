        ...
        <div class="card-body">
            ...
            <form action="../admin/service" method="post">
                ...
                <div class="mb-3">
                    ...
                    <!-- FIXED: NO INDENT, ONE LINE ONLY -->
                    <textarea name="description" class="form-control" rows="4" required><%= service.getDescription().trim() %></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="monthly_fee"
                           class="form-control"
                           value="<%= service.getMonthlyFee() %>" required>
                </div>
