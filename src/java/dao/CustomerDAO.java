...
public class CustomerDAO {
    ...
    String customerSql = "INSERT INTO customers (name, phone_number, email, registration_date, user_id) VALUES (?, ?, ?, ?, ?)";
    ...
    // Legacy backward-compatible insertion method
    public boolean insertCustomer(Customer c) {

        String sql = "INSERT INTO customers (name, phone_number, email, registration_date, user_id) VALUES (?, ?, ?, ?, ?)";
